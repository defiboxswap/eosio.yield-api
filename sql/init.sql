...
CREATE TABLE `protocol`  (
  ...
  `contracts` varchar(255) DEFAULT NULL COMMENT 'additional supporting EOS contracts',
  `evm` varchar(255) DEFAULT NULL COMMENT 'additional supporting EVM contracts',
